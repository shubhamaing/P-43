...
function setup() {
  ...
  restart = createSprite(250,300,30,30);
  restart.addImage(restartImg);
  
  gameOvers = createSprite(250,200,30,30);
...
function draw() {
  ...
  let c = color('magenta');
  fill(c)
  text("Survival Time : " + score + "s",320,40);
  text("Bananas : "+ scoreB,20,40);
  textSize(30);
  let d = color('blue');
  fill(d);
  text("Lost Monkey",140,70);
